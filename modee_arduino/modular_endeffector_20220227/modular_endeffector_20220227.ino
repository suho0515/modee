...
void loop() {
  ...
  //if (Serial.available()) {
    ...
    if (value_1 > 100) return;
      ...
      //dxl.writeControlTableItem(PROFILE_VELOCITY, DXL_ID_2, 30);
      dxl.writeControlTableItem(PROFILE_ACCELERATION, DXL_ID_2, 1 );
      if (dxl.setGoalPosition(DXL_ID_1, degree, UNIT_DEGREE) and (dxl.setGoalVelocity(DXL_ID_2, value_2))) {
        //delay(1000);
        //DEBUG_SERIAL.print("Present Position : ");
        /*
        DEBUG_SERIAL.print(0); // To freeze the lower limit
        DEBUG_SERIAL.print(" ");
        DEBUG_SERIAL.print(10000); // To freeze the upper limit
        DEBUG_SERIAL.print(" ");
    ...
    /*
      if(operation == "pumping") {
      Serial.println("pumping");
      dxl.torqueOff(DXL_ID_1);
      dxl.setOperatingMode(DXL_ID_1, OP_VELOCITY);
      dxl.torqueOn(DXL_ID_1);
      if(dxl.setGoalVelocity(DXL_ID_1, 300)){
        delay(1000);
      ...
      dxl.setOperatingMode(DXL_ID_1, OP_POSITION);
      dxl.torqueOn(DXL_ID_1);
      if(dxl.setGoalPosition(DXL_ID_1, 220.0, UNIT_DEGREE)){
        delay(1000);
        DEBUG_SERIAL.print("Present Position : ");
      ...
      dxl.setOperatingMode(DXL_ID_1, OP_POSITION);
      dxl.torqueOn(DXL_ID_1);
      if(dxl.setGoalPosition(DXL_ID_1, 210.0, UNIT_DEGREE)){
        delay(1000);
        DEBUG_SERIAL.print("Present Position : ");
        DEBUG_SERIAL.println(dxl.getPresentPosition(DXL_ID_1)); DEBUG_SERIAL.println();
      }
      ...
      Serial.println("push_3");
      dxl.torqueOff(DXL_ID_1);
      dxl.setOperatingMode(DXL_ID_1, OP_POSITION);
      dxl.torqueOn(DXL_ID_1);
      if(dxl.setGoalPosition(DXL_ID_1, 360.0, UNIT_DEGREE)){
        delay(1000);
        DEBUG_SERIAL.print("Present Position : ");
        DEBUG_SERIAL.println(dxl.getPresentPosition(DXL_ID_1)); DEBUG_SERIAL.println();
      }
      ...
      else if(operation == "stop_vertical") {
      Serial.println("stop_vertical");
      dxl.torqueOff(DXL_ID_1);
      dxl.setOperatingMode(DXL_ID_1, OP_VELOCITY);
      dxl.torqueOn(DXL_ID_1);
      if(dxl.setGoalVelocity(DXL_ID_1, 0)){
        delay(1000);
        DEBUG_SERIAL.print("Present Velocity : ");
        DEBUG_SERIAL.println(dxl.getPresentVelocity(DXL_ID_1)); DEBUG_SERIAL.println();
      }
      ...
      delay(1000);
      DEBUG_SERIAL.println(dxl.getPresentCurrent(DXL_ID_2, UNIT_MILLI_AMPERE));
      delay(1000);
      }
    */
  }
  ...
  if(record_flag) {
    //DEBUG_SERIAL.print(0); // To freeze the lower limit
    //DEBUG_SERIAL.print(" ");
    //DEBUG_SERIAL.print(360); // To freeze the upper limit
    //DEBUG_SERIAL.print(" ");
    ...
    //DEBUG_SERIAL.println(record_flag);
    //DEBUG_SERIAL.println((dxl.getPresentPosition(DXL_ID_1, UNIT_DEGREE) > degree-2.0));
    //DEBUG_SERIAL.println((dxl.getPresentPosition(DXL_ID_1, UNIT_DEGREE) < degree+2.0));
